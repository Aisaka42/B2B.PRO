...
const ARCHIVE_ROLLBACK_KEY = "project-svetofor-archive-rollback-20260505";
...
const UPLOAD_CONFIG = readUploadServiceConfig("b2b-pro");
      ...
      <article class="card methodIntro">
        <div class="panelHeader">
          <div>
            ...
            <p>Цвет светофора, weekly-балл и итоговый статус проекта формирует агент на стороне протокола. Поверх weekly в карточки проектов добавлен отдельный месячный контур для срезов раздела 6 из уставов.</p>
          </div>
        </div>
        <p>
